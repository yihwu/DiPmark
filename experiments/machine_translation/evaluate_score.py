def pipeline(path = "/fs/nexus-scratch/ywu42/data"):
    ...
    task_worker_ = Process(
        ...
        args=(get_in_ds, f"{path}/machine_translation.txt", tq),
    ...
    store_worker = Process(
        ...
        args=(f"{path}/machine_translation_score_old.txt", r2q, r2qe),
    )
...
def pipeline_dip(path = "/fs/nexus-scratch/ywu42/data"):
    from experiments.common import set_spawn
    ...
    task_worker_ = Process(
        ...
        args=(get_in_ds, f"{path}/machine_translation.txt", tq),
#         kwargs={"batch_size": 8,},
        kwargs={"batch_size": 8, "watermark_only": True, "dip_score": True, "no_gumbel": True},
    )
    ...
    store_worker = Process(
        target=simple_store_worker,
        args=(f"{path}/machine_translation_score.txt", r2q, r2qe),
    )
