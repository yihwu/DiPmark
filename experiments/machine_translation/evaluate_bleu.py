...
def compute_bleu(path = "/fs/nexus-scratch/ywu42/data"):
    ...
    out_ds = load_dataset("json", data_files={"test": f"{path}/machine_translation.txt"})[
        "test"
    ]
    ...
    with open(f"{path}/machine_translation_bleu.txt", "w") as f:
