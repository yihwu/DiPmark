...
def compute_bleu(path = "/fs/nexus-scratch/ywu42/data_supp"):
    ...
    out_ds = load_dataset("json", data_files={"test": f"{data}/machine_translation.txt"})[
        "test"
    ]
    ...
    with open(f"{data}/machine_translation_bleu.txt", "w") as f:
